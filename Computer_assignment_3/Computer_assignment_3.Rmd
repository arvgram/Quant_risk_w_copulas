...
```{r Exercise 4}
#Create copula from mvdc, fit with fmvdc, then we have fml? Or fit copula and only get r param?
# #Get some tau
# tau = 0.2
# 
# #Copulas
...
# #FML (?)
# 
# #These copulas are done via Canonical
...
# 
# (ml.neglog2 = fbvevd(tot.years, model= c("neglog")))
