...
prob2.log <- pbgpd(0,0,model="log",mar1=est.log$par[1:3],mar2=est.log$par[4:6],dep=est.log$par[7
])

(prob1.log - prob2.log)/(1 - prob2.log)

est.psilog = fbgpd(initpar = c(0,1,-0.1,0,1,-0.1,1.2), dat = potdata, model = "psilog", fixed = FALSE, psi = 0.5)


# plotting

z = outer( x, y, pbgpd, model="log", mar1 = est.log$par[1:3], mar2 =
             est.log$par[4:6], dep = est.log$par[7] )
